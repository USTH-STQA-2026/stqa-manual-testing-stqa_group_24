...
| TC-23 | Verify filtering books by Literature category | 1. The data has been reset. 2. The user is logged in successfully. | 1. Open the **Books** tab. 2. Select or enter category `Văn học`. 3. Observe the result list. | Category: `Văn học` | The system displays only books in the `Văn học` category, including BOOK019 and BOOK020. | REQ-03 | EP |
