...
| Mã TC | Nhóm chức năng               | Kết quả mong đợi (tóm tắt)                                         | Kết quả thực tế                                                                                                                                                                          | Kết luận | Minh chứng                                               | Bug |
| ----- | ---------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | -------------------------------------------------------- | --- |
| TC-14 | View Book List               | The system displays the book list with complete book information   | After logging in with account `ba.nguyen@email.com`, opening the **Books** tab displayed the complete book list. Each book showed title, author, category, publication year, and status. | Pass     | ![](./assets/REQ-02/TC-14-complete-book-information.png) | -   |
| TC-15 | View Book List               | Books with different statuses are displayed correctly              | BOOK001 was displayed as **Có sẵn**, BOOK003 as **Đã mượn**, and BOOK007 as **Thất lạc**.                                                                                                | Pass     | ![](./assets/REQ-02/TC-15-book-statuses.png)             | -   |
| TC-16 | View Book List / Return Book | Book status is updated immediately after returning a borrowed book | After MEM006 returned BOOK013 from borrow record BR003, BOOK013 was immediately displayed as **Có sẵn** in the Books tab.                                                                | Pass     | ![](./assets/REQ-02/TC-16-book013-status-updated.png)    | -   |

### REQ-03: Search and Filter Books

| Mã TC | Nhóm chức năng | Kết quả mong đợi (tóm tắt)                                         | Kết quả thực tế                                                                                                                 | Kết luận | Minh chứng                                      | Bug |
| ----- | -------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------------------- | --- |
| TC-17 | Search Books   | Searching by title "Flutter" displays BOOK001                      | After entering keyword `Flutter`, the system displayed BOOK001 – *Lập trình Flutter cơ bản*. No unrelated books were displayed. | Pass     | ![](./assets/REQ-03/TC-17-search-flutter.png)   | -   |
| TC-18 | Search Books   | Searching by author "Nguyễn Minh Đức" displays BOOK001 and BOOK009 | After entering keyword `Nguyễn Minh Đức`, the system displayed BOOK001 and BOOK009.                                             | Pass     | ![](./assets/REQ-03/TC-18-search-author.png)    | -   |
| TC-19 | Search Books   | Lowercase keyword search is case-insensitive                       | After entering keyword `flutter`, the system still displayed BOOK001 – *Lập trình Flutter cơ bản*.                              | Pass     | ![](./assets/REQ-03/TC-19-search-lowercase.png) | -   |
| TC-20 | Search Books   | Uppercase keyword search is case-insensitive                       | After entering keyword `FLUTTER`, the system still displayed BOOK001 – *Lập trình Flutter cơ bản*.                              | Pass     | ![](./assets/REQ-03/TC-20-search-uppercase.png) | -   |
| TC-21 | Search Books   | No matching result displays appropriate message                    | After entering keyword `xyz_khong_ton_tai`, no books were displayed and the message **"Không tìm thấy sách"** appeared.         | Pass     | ![](./assets/REQ-03/TC-21-search-no-result.png) | -   |
| TC-22 | Filter Books   | Filtering by Technology category displays only technology books    | After selecting category **Công nghệ**, only books belonging to the Technology category were displayed.                         | Pass     | ![](./assets/REQ-03/TC-22-filter-cong-nghe.png) | -   |
| TC-23 | Filter Books   | Filtering by Literature category displays only literature books    | After selecting category **Văn học**, only books belonging to the Literature category were displayed.                           | Pass     | ![](./assets/REQ-03/TC-23-filter-van-hoc.png)   | -   |

### REQ-08: Borrow Record Lookup

| Mã TC | Nhóm chức năng                        | Kết quả mong đợi (tóm tắt)                                        | Kết quả thực tế                                                                                                                                                                       | Kết luận | Minh chứng                                                | Bug    |
| ----- | ------------------------------------- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | --------------------------------------------------------- | ------ |
| TC-36 | Borrow Record Lookup                  | A member can view only their own borrow records                   | After logging in as MEM002 and opening the Borrow / Return tab, only borrow records BR001 and BR004 were displayed.                                                                   | Pass     | ![](./assets/REQ-08/TC-36-member-own-records.png)         | -      |
| TC-37 | Borrow Record Lookup                  | The librarian can view all borrow records                         | After logging in as librarian and opening the Borrow / Return tab, all borrow records were displayed. Each record showed record ID, borrowed book, borrow date, due date, and status. | Pass     | ![](./assets/REQ-08/TC-37-librarian-view-all-records.png) | -      |
| TC-38 | Borrow Record Lookup / Access Control | A member must not be able to view another member’s borrow records | Member MEM002 searched for MEM006 and was able to view borrow record BR003 belonging to MEM006.                                                                                       | Fail     | ![](./assets/REQ-08/TC-38-member-views-br003.png)         | BUG-07 |
| TC-39 | Borrow Record Lookup                  | Borrow records display all required fields                        | Borrow record BR001 displayed record ID, borrowed book, borrow date, due date, and status correctly.                                                                                  | Pass     | ![](./assets/REQ-08/TC-39-record-information.png)         | -      |
